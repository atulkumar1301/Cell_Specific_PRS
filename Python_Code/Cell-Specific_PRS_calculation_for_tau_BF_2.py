...
pwd = "/Volumes/ATUL_6TB/Work/Projects/Cell_Specific_PRSs/Full_Data/BF_2/"
f_n = "Data.txt"

##Extracting the Sample ID
print ("Id Extraction Started")
Out_File = open ("/Volumes/ATUL_6TB/Work/Projects/Cell_Specific_PRSs/Full_Data/BF_2/Keep_Patient.txt", 'w', 1)
with open ("/Volumes/ATUL_6TB/Work/Projects/Cell_Specific_PRSs/Full_Data/BF_2/" + f_n, 'r') as datafile:
...
subprocess.run ([plink2, "--pfile", base_file, "--keep", "Keep_Patient.txt", "--maf", "0.05", "--allow-extra-chr", "--make-out", "9_QC_GWAS_data"], cwd = pwd)
