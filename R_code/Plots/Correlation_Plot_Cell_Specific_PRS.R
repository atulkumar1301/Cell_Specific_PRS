...
PRS_1_p <- ggcorrplot(PRS_1_Mat, outline.col = "white", lab = TRUE) + ggtitle ("A) PRS 1") + 
  scale_fill_gradient2(low = "white", high = "red", breaks=c(0, 1), limit=c(0, 1)) + labs(fill = "Corr")
...
PRS_5_p <- ggcorrplot(PRS_5_Mat, outline.col = "white", lab = TRUE) + ggtitle ("E) PRS 5") + 
  scale_fill_gradient2(low = "white", high = "red", breaks=c(0, 1), limit=c(0, 1)) + labs(fill = "Corr")
PRS_5_p <- PRS_5_p + scale_x_discrete(labels = c ("Astrocytes", "Excitatory Neurons", "Inhibitory Neurons", "Microglia", "Oligodendrocyte Precursor Cells", "Oligodendrocytes"))
PRS_5_p <- PRS_5_p + scale_y_discrete(labels = c ("Astrocytes", "Excitatory Neurons", "Inhibitory Neurons", "Microglia", "Oligodendrocyte Precursor Cells", "Oligodendrocytes"))
