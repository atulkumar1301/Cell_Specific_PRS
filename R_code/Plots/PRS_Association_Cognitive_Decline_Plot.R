...
df <- fread ("PRS_Plot_APOE_MMSE.txt")
...
p3 <- p3 + scale_y_continuous (breaks=seq(-0.8, 0.3, 0.05))
...
df_1 <- fread ("PRS_Plot_Non_APOE_MMSE.txt")
...
p4 <- p4 + scale_y_continuous (breaks=seq(-0.66, 0.08, 0.05))
