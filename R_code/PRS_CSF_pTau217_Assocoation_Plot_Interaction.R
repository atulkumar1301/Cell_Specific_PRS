...
df <- fread ("/Volumes/ATUL_6TB/Work/Projects/Cell_Specific_PRSs/Full_Data/Manuscript/PRS_Plots/PRS_Plot_APOE_CSF_pTau217_Abeta_Interaction.txt")
...
p1 <- p1 + scale_y_continuous (breaks=seq(0, 4, 0.5))
...
#### Non-APOE region
df_1 <- fread ("/Volumes/ATUL_6TB/Work/Projects/Cell_Specific_PRSs/Full_Data/Manuscript/PRS_Plots/PRS_Plot_Non_APOE_CSF_pTau217_Abeta_Interaction.txt")
...
p2 <- p2 + scale_y_continuous (breaks=seq(0, 4, 0.5))
...
annotate_figure(plot, top = text_grob("Cell-Specific PRS interaction with A association with CSF pTau217", color = "black", face = "bold", size = 16, family = "serif"))
