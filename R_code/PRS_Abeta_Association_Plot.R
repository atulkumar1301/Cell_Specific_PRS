...
df <- fread ("/Users/shantinaidu/Library/CloudStorage/OneDrive-LundUniversity/Work/Projects/Cell_Specific_PRSs/Full_Data/Manuscript/PRS_Plots/PRS_Plot_APOE_Abeta.txt")
...
p1 <- p1 + scale_y_continuous (breaks=seq(0, 15, 1))
p1 <- p1 + geom_hline (aes(yintercept=-log10(0.05), linetype = "p-value 0.05", col="#F0E442")) +
  geom_hline (aes (yintercept=-log10(8.65E-04), linetype = "FDR p-value 0.05", col="#999999")) +
...
#### Non-APOE region
df_1 <- fread ("/Users/shantinaidu/Library/CloudStorage/OneDrive-LundUniversity/Work/Projects/Cell_Specific_PRSs/Full_Data/Manuscript/PRS_Plots/PRS_Plot_Non_APOE_Abeta.txt")
...
p2 <- p2 + geom_hline (aes(yintercept=-log10(0.05), linetype = "p-value 0.05", col="#F0E442")) +
  geom_hline (aes (yintercept=-log10(8.5E-04), linetype = "FDR p-value 0.05", col="#999999")) +
  scale_linetype_manual(name = "p-value cut off", values = c(2, 2), 
                        guide = guide_legend(override.aes = list(color = c("#999999", "#F0E442"))))
...
annotate_figure(plot, top = text_grob("Cell-Specific PRS association with A", color = "black", face = "bold", size = 16, family = "serif"))
