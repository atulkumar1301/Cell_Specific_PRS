...
df <- fread ("/Volumes/ATUL_6TB/Work/Projects/Cell_Specific_PRSs/Full_Data/Manuscript/PRS_Plots/BF_2/PRS_Plot_APOE_CSF_pTau217_BF_2.txt")
...
#### Non-APOE region
df_1 <- fread ("/Volumes/ATUL_6TB/Work/Projects/Cell_Specific_PRSs/Full_Data/Manuscript/PRS_Plots/BF_2/PRS_Plot_Non_APOE_CSF_pTau217.txt")
