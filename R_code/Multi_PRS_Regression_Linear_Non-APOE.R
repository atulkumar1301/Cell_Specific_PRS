...
for (p in colnames (df)) {
  ...
  model_PRS1 <- glm (Full_File$PHENO ~ PRS_1_A$NORMSCORE + PRS_1_EN$NORMSCORE + PRS_1_IN$NORMSCORE + PRS_1_M$NORMSCORE + PRS_1_OPC$NORMSCORE + PRS_1_O$NORMSCORE +
                       Full_File$E2 + Full_File$E4 + Full_File$Age + Full_File$Gender + Full_File$PC1 + Full_File$PC2 + Full_File$PC3 + Full_File$PC4 + Full_File$PC5 + Full_File$PC6 + Full_File$PC7 + Full_File$PC8 + Full_File$PC9 + Full_File$PC10, family = gaussian)
