...
for (p in colnames (df)) {
  ...
  model_PRS1 <- glm (data2$PHENO ~ data2$NORMSCORE + data2$Age + data2$Gender + data2$E2 + data2$E4 + data2$PC1 + data2$PC2 + data2$PC3 + data2$PC4 + data2$PC5 + data2$PC6 + data2$PC7 + data2$PC8 + data2$PC9 + data2$PC10 + data2$Total_Oligodendrocyte, family = gaussian, data = data2)
  ...
  modeldata20 <- glm (data2$PHENO ~ 1, family = gaussian, data = data2)
  model_PRS2 <- glm (data2$PHENO ~ data2$NORMSCORE + data2$Age + data2$Gender + data2$E2 + data2$E4 + data2$PC1 + data2$PC2 + data2$PC3 + data2$PC4 + data2$PC5 + data2$PC6 + data2$PC7 + data2$PC8 + data2$PC9 + data2$PC10 + data2$Total_Oligodendrocyte, family = gaussian, data = data2)
  ...
  modeldata20 <- glm (data2$PHENO ~ 1, family = gaussian, data = data2)
  model_PRS3 <- glm (data2$PHENO ~ data2$NORMSCORE + data2$Age + data2$Gender + data2$E2 + data2$E4 + data2$PC1 + data2$PC2 + data2$PC3 + data2$PC4 + data2$PC5 + data2$PC6 + data2$PC7 + data2$PC8 + data2$PC9 + data2$PC10 + data2$Total_Oligodendrocyte, family = gaussian, data = data2)
  ...
  modeldata20 <- glm (data2$PHENO ~ 1, family = gaussian, data = data2)
  model_PRS4 <- glm (data2$PHENO ~ data2$NORMSCORE + data2$Age + data2$Gender + data2$E2 + data2$E4 + data2$PC1 + data2$PC2 + data2$PC3 + data2$PC4 + data2$PC5 + data2$PC6 + data2$PC7 + data2$PC8 + data2$PC9 + data2$PC10 + data2$Total_Oligodendrocyte, family = gaussian, data = data2)
  ...
  modeldata20 <- glm (data2$PHENO ~ 1, family = gaussian, data = data2)
  model_PRS5 <- glm (data2$PHENO ~ data2$NORMSCORE + data2$Age + data2$Gender + data2$E2 + data2$E4 + data2$PC1 + data2$PC2 + data2$PC3 + data2$PC4 + data2$PC5 + data2$PC6 + data2$PC7 + data2$PC8 + data2$PC9 + data2$PC10 + data2$Total_Oligodendrocyte, family = gaussian, data = data2)
  ...
  modeldata20 <- glm (data2$PHENO ~ 1, family = gaussian, data = data2)
  model_PRS6 <- glm (data2$PHENO ~ data2$NORMSCORE + data2$Age + data2$Gender + data2$E2 + data2$E4 + data2$PC1 + data2$PC2 + data2$PC3 + data2$PC4 + data2$PC5 + data2$PC6 + data2$PC7 + data2$PC8 + data2$PC9 + data2$PC10 + data2$Total_Oligodendrocyte, family = gaussian, data = data2)
