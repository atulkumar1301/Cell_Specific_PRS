...
#Clinical_data <- fread (file = paste0 ("/Volumes/ATUL_6TB/Work/Projects/Cell_Specific_PRSs/Full_Data/A_beta/", args[1]))
...
df <- Clinical_data [, -1:-34]
for (p in colnames (df)) {
  i = 1
  
  data2 <- PRS_1
  #data2 <- subset (PRS_1, PRS_1$E4! = 0)
  data2$PHENO <- data2$A_Beta_Status
  ...
  model_PRS1 <- glm (data2$PHENO ~ data2$NORMSCORE + data2$Age + data2$Gender + data2$PC1 + data2$PC2 + data2$PC3 + data2$PC4 + data2$PC5 + data2$PC6 + data2$PC7 + data2$PC8 + data2$PC9 + data2$PC10 + data2$Total_Microglia + data2$E2 + data2$E4, family = binomial, data = data2)
  ...
  modeldata20 <- glm (data2$PHENO ~ 1, family = binomial, data = data2)
  model_PRS2 <- glm (data2$PHENO ~ data2$NORMSCORE + data2$Age + data2$Gender + data2$PC1 + data2$PC2 + data2$PC3 + data2$PC4 + data2$PC5 + data2$PC6 + data2$PC7 + data2$PC8 + data2$PC9 + data2$PC10 + data2$Total_Microglia + data2$E2 + data2$E4, family = binomial, data = data2)
  ...
  modeldata20 <- glm (data2$PHENO ~ 1, family = binomial, data = data2)
  model_PRS3 <- glm (data2$PHENO ~ data2$NORMSCORE + data2$Age + data2$Gender + data2$PC1 + data2$PC2 + data2$PC3 + data2$PC4 + data2$PC5 + data2$PC6 + data2$PC7 + data2$PC8 + data2$PC9 + data2$PC10 + data2$Total_Microglia + data2$E2 + data2$E4, family = binomial, data = data2)
  ...
  modeldata20 <- glm (data2$PHENO ~ 1, family = binomial, data = data2)
  model_PRS4 <- glm (data2$PHENO ~ data2$NORMSCORE + data2$Age + data2$Gender + data2$PC1 + data2$PC2 + data2$PC3 + data2$PC4 + data2$PC5 + data2$PC6 + data2$PC7 + data2$PC8 + data2$PC9 + data2$PC10 + data2$Total_Microglia + data2$E2 + data2$E4, family = binomial, data = data2)
  ...
  modeldata20 <- glm (data2$PHENO ~ 1, family = binomial, data = data2)
  model_PRS5 <- glm (data2$PHENO ~ data2$NORMSCORE + data2$Age + data2$Gender + data2$PC1 + data2$PC2 + data2$PC3 + data2$PC4 + data2$PC5 + data2$PC6 + data2$PC7 + data2$PC8 + data2$PC9 + data2$PC10 + data2$Total_Microglia + data2$E2 + data2$E4, family = binomial, data = data2)
  ...
  modeldata20 <- glm (data2$PHENO ~ 1, family = binomial, data = data2)
  model_PRS6 <- glm (data2$PHENO ~ data2$NORMSCORE + data2$Age + data2$Gender + data2$PC1 + data2$PC2 + data2$PC3 + data2$PC4 + data2$PC5 + data2$PC6 + data2$PC7 + data2$PC8 + data2$PC9 + data2$PC10 + data2$Total_Microglia + data2$E2 + data2$E4, family = binomial, data = data2)
  ...
  write.table (TABLE, file = paste0 ("/Volumes/ATUL_6TB/Work/Projects/Cell_Specific_PRSs/Full_Data/A_beta_PRS_Olink/PRS/Microglial_PRS/Non-APOE/PRS_Results_abeta.txt"), sep="\t", quote=FALSE, row.names=FALSE, col.names=TRUE)
}
